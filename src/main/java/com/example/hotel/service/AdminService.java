...
public class AdminService {
    ...
    @Autowired
    public AdminService(DichVuRepository dichVuRepository, PhongRepository phongRepository,
            LoaiPhongRepository loaiPhongRepository, BookingRoomRepository bookingRoomRepository) {
